...
def key_for_record(record):
    return u'{} {} {} {}'.format(record[mafkaAction.ID], record[mafkaAction.NAME],
...
def main(workflow):
    ...
    mafka_topic_list = workflow.cached_data('mafka_topic_list_cache', lambda: mafkaAction.query_all_topics(20),
