...
def main(workflow):
    ...
    cargo_list = workflow.cached_data('cargo_my_list_cache', lambda: devToolsAction.query_my_all_cargos(10),
        ...
        for record in cargo_list:
            wf().add_item(
                ...
                u'[{}][服务数:{}]-{}'.format(
                    ...
                    record[devToolsAction.SWIMLANE] if record[devToolsAction.SWIMLANE] else u'主干'),
