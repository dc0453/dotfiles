...
FSD_ONLINE_STATUS_DIC = {0: u'未开始', 10: u'上线中', 20: u'已上线'}
FSD_FILED_APPLY_STATUS = 'status'
FSD_FILED_ONLINE_TIME = 'projectOnlineTime'
FSD_APPLY_STATUS_DIC = {0: u'开发中', 20: u'交付QA', 30: u'测试中', 50: u'测试完成', 55: u'待上线', 60: u'已上线'}


def query_release_plan_paged_list(url, page_no, page_size):
    cookies_str = login_manager.get_cookies()
    headers = {'Cookie': cookies_str, 'M-Appkey': 'fe_com.sankuai.waimaiqafsd.qafe', 'Dnt': 1}
    ...
    if online_plan_data:
        ...
        result_online_list.extend(
            [{
                ...
                FSD_FILED_ONLINE_STATUS: FSD_ONLINE_STATUS_DIC[record[FSD_FILED_ONLINE_STATUS]]
