...
def query_paged_cargos(pageNum, page_size, stack_filter='own'):
    ...
    headers = {'Cookie': cookies_str, 'Referer': 'https://dev.sankuai.com/cargo/stack', 'web-type': 'devtools'}
    params = {'page': pageNum, 'page_size': page_size, 'stack_filter': stack_filter, 'type': 'user_stacks_by_page'}
...
def query_my_pr_list():
    ...
    cookies_str = login_manager.get_cookies()
    headers = {'Cookie': cookies_str, 'Referer': 'https://dev.sankuai.com/code/home', 'web-type': 'devtools'}
    params = {
        'role': 'reviewer',
        'start': 0,
        'limit': 100,
...
def query_paged_code_repo(pageNum, page_size, keyword=''):
    ...
    cookies_str = login_manager.get_cookies()
    headers = {'Cookie': cookies_str, 'Referer': 'https://dev.sankuai.com/', 'web-type': 'devtools'}
