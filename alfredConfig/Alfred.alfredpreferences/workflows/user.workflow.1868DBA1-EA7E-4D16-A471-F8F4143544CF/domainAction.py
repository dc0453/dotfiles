    ...
    if 'entries' in resp_json:
        ...
        if items:
            return [{
                ...
                DOMAIN_ENV: u'线上' if 'prod' == item[DOMAIN_ENV] else u'线下',
                DOMAIN_NET: u'外网' if 'external' == item[DOMAIN_NET] else u'内网',
                DOMAIN_RANK: u'核心' if 'external' == item[DOMAIN_NET] else u'内网',
