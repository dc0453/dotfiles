...
def main(workflow):
    ...
    all_my_api_list = wf().cached_data('my_all_shepherd_apis',
                                       lambda: shepherdAction.all_my_api_list(),
    ...
    if all_my_api_list:
        for group in all_my_api_list:
            api_query = u'api_group_name={}&api_group_id={}&group_tab=api-manage&api_name={}&api_id={}'.format(
                ...
                utils.url_encode(group[shepherdAction.SHEPHERD_API_GROUP_NAME]),
                group[shepherdAction.SHEPHERD_API_GROUP_ID],
                utils.url_encode(group[shepherdAction.SHEPHERD_API_NAME]),
