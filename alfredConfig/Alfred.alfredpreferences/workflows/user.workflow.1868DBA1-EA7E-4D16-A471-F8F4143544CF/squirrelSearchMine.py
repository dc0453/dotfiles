...
def key_for_record(record):
    return u'{} {} {} {}'.format(record[squirrelAction.CLUSTER_NAME], record[squirrelAction.TOPOLOGY],
...
def main(workflow):
    ...
    squirrel_cluster_list = workflow.cached_data('squirrel_list_cache', lambda: squirrelAction.query_all_clusters(10),
